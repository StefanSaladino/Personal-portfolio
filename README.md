...
`npm test` creates the static export in `out` and verifies all public routes, contact privacy, LinkedIn, GA4 events, mobile-safe case-study titles and the absence of backend starter files.
